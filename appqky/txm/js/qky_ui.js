...
function qkychbox_sigle(){
	$(".qkychbox.yuan").each(function(i) {
		$(".qkychbox.yuan.cur").attr("ischoose","1");
        $(this).click(function(){
			$(".qkychbox.yuan").removeClass("cur");
			$(".qkychbox.yuan").attr("ischoose","0");
			if($(this).attr("ischoose")=="0"){
				
				$(this).attr("ischoose","1").addClass("cur");
				
			}else{
				$(this).attr("ischoose","0").removeClass("cur");
			}
		});
    });
}
