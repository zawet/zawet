...
//闭包限定命名空间
(function ($) {
	var clickDom='<a class="timeicon"><i class="appicon">&#xe603;</i></a>';
	...
	var mhtml='<div class="calselshow fl"><a class="calselectON dian3 cal_moon"></a><div class="caloptionbox moonbox scroll" minnumber="1" maxnumber="13" sel="m"></div></div><span class="fl ml2">月</span>';
	...
	var clearbut='<a class="qkybut hbg brra_4 but_gr cleardate  mt10 fl">清除日期</a>';
	...
	$.fn.calendar.cal_anmate=function(clickid,createid){
			...
			calbox.find(clickid).click(function(){
				...
				$(this).parents(".qky_maskmian").css({"top":"6px"});
			});
		...
		/***以为区域点击 s**/
		 $(document).not($(createid)).click(function(){
			...
			qkymaskmian_td($(createid).parents(".qky_maskmian"));
		});
